...
export default function ThoughtPage() {
  ...
  return (
    <div className="min-h-screen w-full max-w-full bg-white dark:bg-black">
      ...
      <div className="justify-center w-full max-w-full text-black dark:text-white pt-10 md:pt-20 px-[10%] md:px-[20%]">
        <div className="flex justify-between">
          <div className="mx-5 flex flex-col gap-2 mb-6">
            <h1 className="text-4xl md:text-6xl font-serif text-black dark:text-white">{thought.title}</h1>
